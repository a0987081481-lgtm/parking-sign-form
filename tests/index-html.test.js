...
test('public page cache-busts local assets so GitHub Pages does not keep stale scripts', () => {
  ...
  const expectedFragments = [
    'href="style.css?v=20260908-1"',
    'src="config.js?v=20260908-1"',
    'src="config-loader.js?v=20260908-1"',
    'src="app.js?v=20260908-1"',
  ];
...
test('admin page cache-busts local assets so maintenance UI also refreshes', () => {
  ...
  const expectedFragments = [
    'href="style.css?v=20260908-1"',
    'src="config.js?v=20260908-1"',
    'src="maintenance-settings.js?v=20260908-1"',
    'src="config-loader.js?v=20260908-1"',
    'src="github-contents.js?v=20260908-1"',
    'src="maintenance-sync.js?v=20260908-1"',
    'src="admin-config-form.js?v=20260908-1"',
    'src="admin.js?v=20260908-1"',
  ];
